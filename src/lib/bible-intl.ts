...
const MESSAGES: Record<BibleLocale, Record<string, string>> = {
  en: {
    ...
    learnOriginTitle: "Bible Origin & Books Formation",
  ...
  vi: {
    ...
    learnOriginTitle: "Nguồn gốc & Sự hình thành Kinh Thánh",
  ...
  zh: {
    ...
    readIndependent: "獨立",
    readChapterN: "第 {n} 章",
    readChapterVerse: "第 {ch} 章，第 {v} 節",
    readBook: "書卷",
    readOldTestament: "舊約",
    readNewTestament: "新約",
    readOldShort: "舊",
    readNewShort: "新",
    readSelectPassage: "選擇經文",
    readTextSize: "字體大小",
    readFont: "字體",
    readEmptyStateTitle: "請在上方選擇譯本",
    readEmptyStateSubtitle: "選擇一或兩個譯本進行對照。",
    readNoContent: "此選擇目前沒有經文。",
    readSelectAnother: "請嘗試選擇其他書卷、章節或譯本。",
    ...
    searchPlaceholder: "搜尋書卷、章、節…",
    searchDialogTitle: "搜尋聖經",
    searchDialogDescription: "搜尋書卷、章或節",
    searchClearLabel: "清除搜尋",
    searchHintTitle: "搜尋方式",
    searchHintTrySearchingFor: "試試搜尋",
    searchHintSingleBook: "單一卷書：",
    searchHintBookChapter: "書卷 + 章：",
    searchHintBookVerse: "書卷 + 節：",
    searchHintSingle: "單節：約翰 3 16",
    searchHintTwo: "兩節：約翰 1 12 34",
    searchHintRange: "連續範圍：約翰 1 12-34 或 12:34",
    searchHintContext: "或按主題搜尋：例如創造、十誡",
    searchNoResults: "沒有結果。試試「約翰 3 16」或「馬太 1」。",
    searchNoResultsFor: "沒有結果：",
    searchNoResultsTry: "試試其他書卷名稱或簡稱",
    searchSearching: "搜尋中…",
    searchGoTo: "前往",
    searchContextHeading: "符合此內容的章節",
    tocBook: "書卷",
    tocBooks: "書卷",
    learnModule1Title: "What Is the Bible?",
    learnModule2Title: "Bible Origin & Books Formation",
