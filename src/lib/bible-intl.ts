...
const MESSAGES: Record<BibleLocale, Record<string, string>> = {
  en: {
    ...
    langPageNavArticles: "Deep Dive",
    langPageNavArticlesDesc: "Weekly devotional articles for deeper study.",
    langPageNavFlashcards: "Flashcards",
    langPageNavGlossary: "Glossary",
    navStudy: "Study Hub",
    navStudyLists: "My Study Lists",
  ...
  vi: {
    ...
    langPageNavRead: "Đọc",
    langPageNavArticles: "Đào Sâu",
    langPageNavArticlesDesc: "Bài tĩnh tâm hàng tuần để tìm hiểu sâu hơn.",
