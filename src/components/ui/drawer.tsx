...
(DrawerPortal as React.ComponentType & { displayName?: string }).displayName =
  "DrawerPortal";
    ...
    <DrawerPortal>
      ...
      <VaulDrawer.Content
        className={cn(
          ...
          data-[vaul-drawer-direction=bottom]:max-h-[96vh]
          data-[vaul-drawer-direction=bottom]:rounded-t-[10px]`,
          `data-[vaul-drawer-direction=top]:inset-x-0
          data-[vaul-drawer-direction=top]:top-0
          data-[vaul-drawer-direction=top]:max-h-[96vh]
          data-[vaul-drawer-direction=top]:rounded-b-[10px]`,
          `data-[vaul-drawer-direction=left]:inset-y-0
          data-[vaul-drawer-direction=left]:left-0
          data-[vaul-drawer-direction=left]:max-w-[96vw]
          data-[vaul-drawer-direction=left]:rounded-r-[10px]`,
          `data-[vaul-drawer-direction=right]:inset-y-0
          data-[vaul-drawer-direction=right]:right-0
          data-[vaul-drawer-direction=right]:max-w-[96vw]
          data-[vaul-drawer-direction=right]:rounded-l-[10px]`,
          "data-[state=open]:animate-in data-[state=closed]:animate-out",
