...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      focus:ring-ring flex h-10 w-full items-center justify-between rounded-md border px-3
      py-2 text-sm focus:ring-2 focus:ring-offset-2 focus:outline-none
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      items-center rounded-sm py-1.5 pr-2 pl-8 text-sm outline-none select-none
