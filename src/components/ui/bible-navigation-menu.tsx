...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root
      data-slot="bible-navigation-menu"
...
function NavigationMenuList({
  ...
  return (
    <NavigationMenuPrimitive.List
      data-slot="bible-navigation-menu-list"
      className={cn(
...
function NavigationMenuItem({
  ...
  return (
    <NavigationMenuPrimitive.Item
      data-slot="bible-navigation-menu-item"
...
/** Bible nav: minimal trigger so BibleNavBar className controls all appearance (no bg/accent). */
function NavigationMenuTrigger({
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      data-slot="bible-navigation-menu-trigger"
      className={cn(
        `group focus-visible:ring-ring inline-flex h-max w-max items-center justify-center
...
function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      data-slot="bible-navigation-menu-content"
      className={cn(
...
/** Bible nav: minimal link so BibleNavBar className controls appearance. */
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      data-slot="bible-navigation-menu-link"
