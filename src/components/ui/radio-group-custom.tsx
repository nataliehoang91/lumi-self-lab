...
function RadioGroupItemCustom({
  ...
  return (
    <RadioGroupPrimitive.Item
      ...
      className={cn(
        `border-muted-foreground/30 bg-background aspect-square size-4 shrink-0
        rounded-full border-2 transition-all duration-200 outline-none`,
        ...
        `data-[state=checked]:focus-visible:bg-primary/10
        ...
        `disabled:hover:border-muted-foreground/30 disabled:hover:bg-background
    ...
    >
      ...
      >
        <div
          className={cn(
            "bg-primary dark:bg-od-bright-teal size-1.5 rounded-full",
            circleClassName
          )}
        />
      </RadioGroupPrimitive.Indicator>
