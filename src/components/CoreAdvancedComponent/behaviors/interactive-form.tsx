          ...
          if (action) {
            ...
            startTransition(async () => {
              ...
              if ("redirect" in result && typeof result.redirect === "string") {
                ...
                // If refresh is also requested, refresh after navigation completes
              ...
              startTransition(() => {
                ...
                if ("extraActions" in result && result.extraActions) {
                  result.extraActions.forEach((action) => action());
                }
              });
            });
          }
...
export function SubmitMessage({ children, className }: ComponentProps<"span">) {
  const isPending = useFormPending();
