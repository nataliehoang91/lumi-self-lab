...
const MODULES = [
  ...
  },
  {
    ...
    desc: (
      <>
        Chúa Giê-xu là nhân vật trung tâm của Kinh Thánh. Ngài tuyên bố điều gì về chính
        mình — và tại sao cái chết và sự sống lại của Ngài được xem là bước ngoặt của lịch
        sử?
      </>
    ),
    min: 6,
  },
  {
    ...
    desc: (
      <>
        Đức tin không chỉ là tin một ý tưởng. Vậy tin cậy Đức Chúa Trời nghĩa là gì — và
        điều đó ảnh hưởng thế nào đến cách bạn sống mỗi ngày?
      </>
    ),
    min: 5,
  },
  ...
  return (
    <article aria-label="Học - Bắt đầu tại đây">
      <LearnPageIntro
        ...
        subtitle={
          <>
            Trước khi đọc từng câu Kinh Thánh, hãy hiểu bức tranh lớn — Kinh Thánh kể câu
            chuyện gì, <strong>Chúa Giê-xu</strong> là ai, và đức tin thực sự thay đổi
