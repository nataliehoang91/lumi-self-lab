 ...
 *   onSocialClick={handleSocialSignIn}
 * />
 * ```
 */
...
type SocialProvider = "oauth_google" | "oauth_facebook" | "oauth_github";

interface SocialLoginButtonsProps {
  mode: "sign-in" | "sign-up";
  isLoaded: boolean;
  socialLoading: string | null;
  onSocialClick: (strategy: SocialProvider) => void;
}
...
export function SocialLoginButtons({
  ...
  const actionText = mode === "sign-in" ? "Signing in" : "Signing up";

  return (
    <div className="space-y-3">
      {SOCIAL_PROVIDERS.map((provider) => {
        const isLoading = socialLoading === provider.strategy;
        ...
        return (
          <Button
            ...
            onClick={() => onSocialClick(provider.strategy)}
