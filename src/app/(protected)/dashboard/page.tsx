              ...
              <Card className="p-6 bg-card border-border/50 rounded-3xl">
                ...
                <div className="space-y-4">
                  ...
                  <Link href="/manager">
                    <Button
                      variant="outline"
                      className="w-full rounded-2xl gap-2 bg-transparent"
                    >
                  ...
                  <Link href="/joined-experiments">
                    ...
                    >
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-xs text-muted-foreground">
                          {userData?.pendingAssignments || 0} experiments
                          waiting
                        </div>
                      </div>
                    </Button>
                ...
                {userData?.orgs.map((org) => (
                  ...
                  >
                    <div className="flex items-center gap-4 mb-3">
                      <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-secondary to-primary flex items-center justify-center text-white font-bold text-lg">
                        {org.name.charAt(0)}
                      </div>
                      <div>
                        ...
                        <Badge className="bg-secondary/10 text-secondary border-secondary/20 rounded-full text-xs mt-1">
                          {org.role === "org_admin" ? "Org Admin" : org.role}
                        </Badge>
                      </div>
                    </div>
                    <Link href={`/manager/orgs/${org.id}`}>
                      <Button
                        variant="outline"
