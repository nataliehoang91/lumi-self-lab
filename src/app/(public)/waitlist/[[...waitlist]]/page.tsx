          ...
          <div className="grid items-center gap-12 md:grid-cols-2 lg:gap-16">
            <div className="space-y-8">
              <div className="space-y-4">
                <Badge
                  variant="outline"
                  className="bg-sky-blue/10 border-sky-blue/30 text-sky-blue gap-1.5 px-3
                    py-1"
                >
                ...
                <h1
                  className="text-foreground text-5xl leading-tight font-bold text-balance
                    md:text-6xl"
                >
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <div
                    className="bg-violet/20 mt-0.5 flex h-6 w-6 flex-shrink-0 items-center
              ...
              <div className="grid grid-cols-3 gap-4 pt-4">
                <Card className="bg-card/50 border-border/30 rounded-2xl p-4 text-center">
