...
export default function ExperimentOrgLinkingPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params);
  ...
  return (
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <Card className="p-8">
          <div className="mb-6">
            <h1 className="text-2xl font-semibold text-foreground mb-2">Organisation Linking</h1>
            ...
            {isLinked && linkedOrgId ? (
              ...
              <Card className="p-4 bg-muted/50 border-border">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-foreground">Personal Experiment</p>
                    <p className="text-sm text-muted-foreground">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground space-y-2">
                  <p>
                    When linked to an organisation, your experiment contributes to aggregate
                    insights. Your personal data stays private.
                  </p>
                  <div>
