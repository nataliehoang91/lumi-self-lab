...
export const VERSE_COUNTS: number[][] = [
  [
    ...
    24, 20, 67, 34, 36, 38, 24, 20, 25, 35, 30, 24, 32, 34, 24, 40, 38, 32, 41, 40, 28,
    32, 35, 26, 38, 31, 34, 34, 24,
  ], // Genesis
  [
    22, 25, 22, 31, 23, 30, 29, 28, 35, 29, 10, 51, 22, 31, 27, 36, 16, 27, 26, 25, 26,
    36, 31, 33, 18, 40, 37, 21, 43, 46, 38, 18, 35, 23, 35, 35, 38, 29, 31, 43,
  ], // Exodus
  [
    17, 16, 17, 35, 26, 23, 38, 36, 24, 20, 47, 8, 59, 57, 33, 34, 16, 30, 37, 27, 24, 33,
    44, 23, 55, 46, 34,
  ], // Leviticus
  [
  ...
  [
    ...
    15, 5, 23, 11, 13, 12, 9, 9, 5, 8, 28, 22, 35, 45, 48, 43, 13, 31, 7, 10, 10, 9, 8,
    18, 19, 2, 29, 176, 7, 8, 9, 4, 8, 5, 6, 5, 6, 8, 8, 3, 18, 3, 3, 21, 26, 9, 8, 24,
  ...
  [
    28, 10, 27, 17, 17, 14, 27, 18, 11, 22, 25, 28, 23, 23, 8, 63, 24, 32, 14, 44, 37, 31,
    49, 27, 17, 21, 36, 21, 26, 21, 26, 18, 32, 33, 31, 15, 38, 28, 23, 29, 49, 26, 20,
    27, 31, 25, 24, 23, 35,
  ], // Ezekiel
